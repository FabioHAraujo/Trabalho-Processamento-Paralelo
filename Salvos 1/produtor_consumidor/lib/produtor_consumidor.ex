defmodule ProdutorConsumidor do
  ...
  def init(state) do
    schedule_producer(:produtor1)
    schedule_producer(:produtor2)
    {:ok, state}
  end
  ...
  defp produce_item(producer_name, state) do
    ...
    schedule_producer(producer_name)
    {item, new_state}
  end

  defp schedule_producer(producer_name) do
    Process.send_after(self(), {:produce, producer_name}, 0)
  end
